    ...
    const handleNumTicketsChange = (e) => {
      ...
      const handleProceed = () => {
        if (numTickets > 5) {
          ...
          navigate(`/event/${event._id}/ordersummary/paymentsummary?numTickets=${numTickets}`);
                          ...
                          className='
                            ...
                            <br/>
                              ...
                              <ul className="custom-list">
                                  ...
                                  <li> Each individual is allowed to purchase a maximum of 5 tickets for this event to ensure fair distribution. </li>
                    ...
                    "
                      >
                        ...
                        <div className='text-sm flex justify-between' >
                              <div className='text-left mt-5'>Ticket name</div>
                              <div className='text-right mt-5 mb-6 pr-5'>{event.title}</div>
                        </div>
                        <div className='text-sm flex justify-between' >
                              <div className='text-left mt-5'>Number of Tickets</div>
                        ...
                        <div className='text-sm font-bold flex justify-between' >
                          ...
                          <div className='text-right mt-5 mb-6 pr-5'>Ksh. {event.ticketPrice * numTickets}</div>
                        </div>
