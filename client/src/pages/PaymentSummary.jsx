...
export default function PaymentSummary() {
    ...
    // const [numTickets, setNumTickets] = useState(parseInt(numTickets, 10) || 1);
        ...
        axios.get(`/event/${id}/ordersummary/paymentsummary`, {
          ...
          setTicketDetails(prevTicketDetails => ({
            ...
            ticketDetails: {
              ...
              eventname: response.data.event.title,
              eventdate: response.data.event.eventDate.split("T")[0],
              eventtime: response.data.event.eventTime,
              ticketprice: response.data.event.ticketPrice,
              numtickets: response.data.paymentSummary.numTickets,
              totalprice: response.data.paymentSummary.totalPrice
            }
          }));
        }).catch((error) => {
    ...
    return (
      ...
      <div className="float-right bg-blue-100 w-1/4 p-5 mt-8 mr-12">
          ...
          <div className="space-y-1">
            ...
            <div>
            <p className="float-right">{numTickets} Ticket{numTickets !== 1 ? 's' : ''}</p>
            </div>
